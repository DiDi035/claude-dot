...
description: Use when asked to remove AI-isms, clean up AI writing, edit writing for AI patterns, audit writing for AI tells, or make content sound less like AI. Supports detection-only mode for flagging without rewriting.
version: 3.3.0
license: MIT
